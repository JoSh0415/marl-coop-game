...
def train_decentralised_comms(level_name="level_1"):
    EXPERIMENT_NAME = f"ppo_decentralised_comms_{level_name}"
    ...
    dummy_env = GymCoopEnvRLlibDecentralisedComms(
        {
    ...
    cfg = (
        ...
        .environment(
            env="marl_coop_decentralised_comms",
            env_config={
                "level_name": level_name,
                "stack_n": 4,
                "render": False,
...
if __name__ == "__main__":
    train_decentralised_comms(level_name="level_1")